...
Output: <YOUR_CATALOG>.<YOUR_SCHEMA>.card_clusterer (MLflow model)
        <YOUR_CATALOG>.<YOUR_SCHEMA>.cluster_centroids (Delta table)
"""

# COMMAND ----------

# ── Configuration ────────────────────────────────────────────────────────────
# TODO: Set these to your catalog, schema, and experiment path
...
EXPERIMENT_NAME = "/Users/<YOUR_EMAIL>/seconddinner-serving-core"  # TODO: set your email
N_CLUSTERS = 12
...
class CardClustererModel(mlflow.pyfunc.PythonModel):
    ...
    def predict(self, context, model_input):
        ...
        distances = np.min(self.kmeans.transform(scaled), axis=1)
