...
Generates ~100 Marvel Snap card records with features, tags, and archetypes.
Output: <YOUR_CATALOG>.<YOUR_SCHEMA>.cards
"""
...
# Write with CDF enabled (required for online table sync)
